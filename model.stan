...
transformed parameters {
  ...
  for (e in 1:N_experiment){
    ...
    print("conc_init", conc_init[e, balanced_mic_ix]);
    print("initial_time", initial_time);
    print("timepoints", timepoints);
    print("rel_tol_forward", rel_tol_forward); 
    print("abs_tol_forward", abs_tol_forward);
    print("rel_tol_backward", rel_tol_backward);
    print("abs_tol_backward", abs_tol_backward);
    print("rel_tol_quadrature", rel_tol_quadrature);
    print("abs_tol_quadrature", abs_tol_quadrature);
    print("max_num_steps", max_num_steps);
    print("num_steps_between_checkpoints", num_steps_between_checkpoints);
    print("interpolation_polynomial", interpolation_polynomial);
    print("solver_forward", solver_forward);
    print("solver_backward", solver_backward);
